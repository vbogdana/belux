                            ...
                            <div class="group">
                                <div class="col span_1_of_2">
                                    <div class="package-card perspective floating">
                                        <div class="rotate">
                                            <img id="vip-luxury" src="<?php echo url("") ?>/images/cards/front-5.svg" class="card" width="300.5px" height="187px" />                               
                                        </div>
                                    </div>
                                </div>
